      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="bg-gradient-to-br from-yellow-600/20 to-yellow-800/20 border border-yellow-500/30 rounded-xl p-4">
            ...
            <div className="text-2xl font-bold text-yellow-500">{scores[0]?.username || 'N/A'}</div>
          ...
          <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 border border-blue-500/30 rounded-xl p-4">
            ...
            <div className="text-2xl font-bold text-blue-500">{scores.length}</div>
          ...
          <div className="bg-gradient-to-br from-green-600/20 to-green-800/20 border border-green-500/30 rounded-xl p-4">
            ...
            <div className="text-2xl font-bold text-green-500">{recentWins.length}/10</div>
                ...
                {scores.map((score, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      {/* Avatar */}
                      <div className="w-10 h-10 bg-gradient-to-br from-yellow-600 to-yellow-800 rounded-full flex items-center justify-center text-lg">
                        {score.avatarEmoji}
                      </div>
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-yellow-500">{score.totalPoints}</div>
